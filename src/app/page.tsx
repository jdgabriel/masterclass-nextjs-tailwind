      ...
      <div className="mt-6 flex flex-col">
        ...
        >
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            <label
              htmlFor="photo"
              className="gap-2 text-sm font-medium text-zinc-700 dark:text-zinc-300"
            >
              Your photo
            ...
            <InputFile.Root className="flex flex-col gap-2 lg:flex-row lg:items-start lg:gap-5">
              <InputFile.Preview />
              <InputFile.Trigger />
              <InputFile.Control />
            </InputFile.Root>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            <label
              htmlFor="portfolio"
              className="gap-3 text-sm font-medium text-zinc-700 dark:text-zinc-300"
            >
              Portfolio projects
              <span className="mt-0.5 block text-sm font-normal text-zinc-500">
